                ...
                <div class="row grid">
                    ...
                    <div class="col-lg-4 col-md-4 all dev">
                      <div class="product-item">
                        ...
                        <div class="down-content">
                          <a href="#"><h4>Laptop Dell xps 2000</h4></a>
                          <h6>$16.75</h6>
                          <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-md-4 all gra">
                      <div class="product-item">
                        ...
                        <div class="down-content">
                          <a href="#"><h4>RAV4 Hybrid</h4></a>
                          <h6>$26,888</h6>
                          <p>It just arrived on our lot this past week! All of the premium features,  ...</p>
                        </div>
                      </div>
                    </div>
                    <div class="col-lg-4 col-md-4 all gra">
                      <div class="product-item">
                        ...
                        <div class="down-content">
                          <a href="#"><h4>Harveyly Dakinson</h4></a>
                          <h6>$3224.60</h6>
                          <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                        </div>
                      </div>
